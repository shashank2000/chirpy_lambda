...
PROD_LOGGER_SETTINGS = LoggerSettings(
    logtoscreen_level=PRIMARY_INFO_NUM,
...
def setup_logger(logger_settings, session_id=None):
    ...
    if logger_settings.logtoscreen_allow_multiline and logger_settings.allow_rich_formatting:
        ...
        stream_formatter = ChirpyFormatter(
            allow_multiline=logger_settings.logtoscreen_allow_multiline,
            use_color=logger_settings.logtoscreen_usecolor,
    ...
    add_new_level(chirpy_logger, "BLUEJAY", PRIMARY_INFO_NUM - 4)
