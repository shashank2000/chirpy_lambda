...
class BaseSymbolicState:
    ...
    # current_entity_store: [SUPERNODE.NAME : value of current_entity when SUPERNODE last ran ]
    current_entity_store: DefaultDict[str, Any] = field(default_factory=lambda: defaultdict(lambda: None))
