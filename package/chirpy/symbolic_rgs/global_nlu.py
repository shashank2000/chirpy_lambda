...
IDENTITY_QUESTIONS = [
    (
        (r"[\w\s\']*your name[\w\s]*", r"[\w\s\']*you called[\w\s]*"),
    ...
    (
        (
            r"[\w\s\']*who are you$",
            r"[\w\s\']*who are you alexa$",
            r"[\w\s\']*who you are$",
            r"[\w\s\']*who you are alexa$",
            r"[\w\s\']*who built you$",
            r"[\w\s\']*who made you$",
            r"[\w\s\']*who are you made by$",
            r"[\w\s\']*what are you$",
            r"[\w\s\']*tell me about yourself[\w\s]*",
            r"[\w\s\']*tell me about you$",
            r"[\w\s\']*tell me about you alexa$",
        ),
        "I am an Alexa Prize social bot built by a university.",
    ),
    (
        (
            r"[\w\s\']*where[\w\s\']*you[\w\s]*live",
            r"[\w\s\']*where[\w\s\']*you[\w\s\']*from",
            r"[\w\s\']*where are you( |$)[\w\s\']*",
        ),
